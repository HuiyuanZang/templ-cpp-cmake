...
# To pass a list of libraries, use: "item1,item2"
function(bundle_static_library tgt_name bundled_tgt_name extra_libs)
  ...
  set(bundled_tgt_full_name
      ${CMAKE_BINARY_DIR}/${bundled_tgt_name}${CMAKE_STATIC_LIBRARY_SUFFIX})
  message(${CMAKE_CXX_COMPILER_ID})
  if(CMAKE_CXX_COMPILER_ID MATCHES "^(Clang|GNU)$"
     OR CMAKE_CXX_COMPILER_ID MATCHES "^(AppleClang|GNU)$")
    ...
    foreach(tgt IN LISTS extra_libs)
      file(APPEND ${CMAKE_BINARY_DIR}/${bundled_tgt_name}.ar.in
           "ADDLIB ${tgt}\n")
    endforeach()
